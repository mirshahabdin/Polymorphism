...
bHA = 21.0; % Daily host adult fecundity (number of eggs)
c = 7.5*10^-5; % Competition mortality coefficient
k = 0.01; % Interference parameter
a = 0.01; % Parasitoid attack rate
dHE = 0.017; % Background host egg mortality
dHL = 0.0; % Background host larval mortality
dHP = 0.0; % Background host pupal mortality
dHA = 0.1; % Background host adualt mortality
